...
public class BlogPostDBImplTest {
    ...
    public void testUpdate() {
        ...
        returnedPost.setTitle(returnedPost.getTitle() + " - updated!");
        returnedPost.setContent(returnedPost.getContent() + " - also updated!");
        blogPostDao.update(returnedPost);
        
        // Test get method.
        BlogPost returnedPostB = blogPostDao.getById(id);
        assertTrue(verifyBlogPost(returnedPostB, returnedPost));
